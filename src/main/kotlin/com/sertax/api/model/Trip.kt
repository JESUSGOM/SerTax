...
data class Trip(
    ...
    // --- AÑADIDO: Campo para registrar la asignación manual ---
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "manual_assignment_association_id")
    var manualAssignmentAssociation: Association? = null
)
...
enum class TripStatus {
    ...
    Cancelled,
    NoShow,
    PendingManualAssignment // <-- AÑADIDO
}